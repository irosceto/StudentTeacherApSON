...
fun ProfileScreenContent(
    ...
    //kullanıcı profil fotoğrafına tıkladığında bu tetiklenir android sistemde fotoğraf seçimi başarıyla geçerkleşitse içindeki atama ile profil fotoğrafı güncellenir
